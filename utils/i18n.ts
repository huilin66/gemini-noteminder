      ...
      sections: {
        ...
        notebook: {
          ...
          items: [
             ...
             "Action Buttons: Use 'Start' and 'Finish' buttons in the actions column to quickly track task progress."
          ]
        },
        note: {
          title: "Note",
        ...
        settings: {
          ...
          items: [
             ...
             "AI / LLM: Configure your preferred LLM provider (Gemini, DeepSeek, OpenAI), API Key, and Prompts."
          ]
        },
        update: {
          ...
          items: [
            ...
            "v4.2.0: Introduced Bookshelf background and Internationalization.",
            "v4.0.0: Initial major release with AI parsing."
          ]
        }
      }
    }
      ...
      sections: {
        ...
        notebook: {
          ...
          items: [
             ...
             "时间选择器：日期与时间独立分开，滚轮式选择时间。",
             "状态操作：使用操作列的“开始”与“完成”按钮快速切换任务状态。"
          ]
        },
        note: {
          title: "桌面便签 (Note)",
